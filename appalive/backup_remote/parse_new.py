...
result_paths = [
                ...
                "/home/zhouhao/KeepAliveWS/appalive/backup_before/vehicle_system_out.log",
                "/home/zhouhao/KeepAliveWS/appalive/backup_before/communication_system_out.log",
                "/home/zhouhao/KeepAliveWS/appalive/backup_before/health_system_out.log",
                "/home/zhouhao/KeepAliveWS/appalive/backup_before/maps_system_out.log",
                "/home/zhouhao/KeepAliveWS/appalive/backup_before/music_system_out.log",
                "/home/zhouhao/KeepAliveWS/appalive/backup_before/social_system_out.log",
                "/home/zhouhao/KeepAliveWS/appalive/backup_before/travel_system_out.log",
                "/home/zhouhao/KeepAliveWS/appalive/backup_before/video_system_out.log",
                "/home/zhouhao/KeepAliveWS/appalive/backup_before/weather_system_out.log",
                "/home/zhouhao/KeepAliveWS/appalive/fdroid/system_out_3.log",
               ]
...
print "-- -- -- -- -- -- -- -- -- --"
print "b01_number -> " + str(b01_number) + ", " + str(1.0 * b01_number / valid_number * 100)
print "b02_number -> " + str(b02_number) + ", " + str(1.0 * b02_number / valid_number * 100)
print "b03_number -> " + str(b03_number) + ", " + str(1.0 * b03_number / valid_number * 100)
print "b04_number -> " + str(b04_number) + ", " + str(1.0 * b04_number / valid_number * 100)
print "b05_number -> " + str(b05_number) + ", " + str(1.0 * b05_number / valid_number * 100)
print "b06_number -> " + str(b06_number) + ", " + str(1.0 * b06_number / valid_number * 100)
print "b07_number -> " + str(b07_number) + ", " + str(1.0 * b07_number / valid_number * 100)
print "b08_number -> " + str(b08_number) + ", " + str(1.0 * b08_number / valid_number * 100)
print "b09_number -> " + str(b09_number) + ", " + str(1.0 * b09_number / valid_number * 100)
print "b10_number -> " + str(b10_number) + ", " + str(1.0 * b10_number / valid_number * 100)
print "b11_number -> " + str(b11_number) + ", " + str(1.0 * b11_number / valid_number * 100)
print "b12_number -> " + str(b12_number) + ", " + str(1.0 * b12_number / valid_number * 100)
print "-- -- -- -- -- -- -- -- -- --"
